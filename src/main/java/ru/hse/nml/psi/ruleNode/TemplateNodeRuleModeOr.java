...
public abstract class TemplateNodeRuleModeOr extends ASTWrapperPsiElement implements PsiNamedElement {

    protected String name = null;

    public TemplateNodeRuleModeOr(@NotNull ASTNode node) {
        super(node);
    }
