...
public class NodeRuleModeOr extends TemplateNodeRuleModeOr {

    public static final Logger LOG = Logger.getInstance("ru.hse.nml.psiGeneral.ruleNode.NodeRuleModeOr");

    public NodeRuleModeOr(@NotNull ASTNode node) {
        super(node);
    }
