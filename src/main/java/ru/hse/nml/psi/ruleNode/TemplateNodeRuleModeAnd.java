...
public abstract class TemplateNodeRuleModeAnd extends ASTWrapperPsiElement implements PsiNamedElement {


    protected String name = null;

    public TemplateNodeRuleModeAnd(@NotNull ASTNode node) {
        super(node);
    }
