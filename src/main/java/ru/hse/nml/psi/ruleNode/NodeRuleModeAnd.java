...
public class NodeRuleModeAnd extends TemplateNodeRuleModeAnd {

    public static final Logger LOG = Logger.getInstance("ru.hse.nml.psiGeneral.ruleNode.NodeRuleModeAnd");

    public NodeRuleModeAnd(@NotNull ASTNode node) {
        super(node);
    }

    @Override
    public IElementType getRuleRefType() {
        return NmlTypes.TOKEN_ELEMENT_TYPES.get(NmlLexer.MODE);
    }
    ...
    public boolean isFragment() {
        return getNode().findChildByType(NmlTypes.TOKEN_ELEMENT_TYPES.get(NmlParser.RULE_opType)) != null;
    }
}
