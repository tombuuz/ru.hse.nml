...
public class NodeRuleMem extends TemplateNodeRuleMem {

    public static final Logger LOG = Logger.getInstance("ru.hse.nml.psiGeneral.ruleNode.NodeRuleMem");

    public NodeRuleMem(@NotNull ASTNode node) {
        super(node);
    }

    @Override
    public IElementType getRuleRefType() {
        return NmlTypes.TOKEN_ELEMENT_TYPES.get(NmlLexer.MEM);
    }
