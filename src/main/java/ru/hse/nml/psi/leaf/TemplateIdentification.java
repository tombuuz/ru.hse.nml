...
public abstract class TemplateIdentification extends LeafPsiElement implements PsiNamedElement {

    protected String name = null;

    public TemplateIdentification(@NotNull IElementType type, CharSequence text) {
        super(type, text);
    }
