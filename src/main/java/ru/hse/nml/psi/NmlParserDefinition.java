...
public class NmlParserDefinition implements ParserDefinition {
    ...
    public PsiParser createParser(Project project) {
        final ru.hse.nml.NmlParser parser = new ru.hse.nml.NmlParser(null);
    ...
    public PsiElement createElement(ASTNode node) {
        ...
        switch (ruleIElementType.getRuleIndex()) {
            case NmlParser.RULE_specification:
                return new NodeSpecification(node);
            case NmlParser.RULE_declaration:
                return new NodeDeclare(node);
